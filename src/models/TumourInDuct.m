classdef TumourInDuct < AbstractCellSimulation
	...
	methods
		...
		function obj  = TumourInDuct(radius, t0, tg, mpe, f, seed)
			...
			obj.AddNeighbourhoodBasedForce(CellTypeInteractionForce(att, rep, dAsym, dSep, dLim, cellTypes, obj.dt, false));
			% obj.AddNeighbourhoodBasedForce(CellTypeNodeCellForce(att, rep, dAsym, dSep, dLim, cellTypes, obj.dt, true));
			...
			obj.pathName = sprintf('TumourInDuct/rad%gt0%gtg%gmpe%gf%gr%gaN%gaNM%gaM%gdA%gdSN%gdSNM%gdSM%gdLN%gdLNM%gdLM%gnEdges%g_seed%g/',radius,t0,tg,mpe,f,r,aN,aNM,aM,dA,dSN,dSNM,dSM,dLN,dLNM,dLM,nEdges, seed);
