...
if [ $found = 1 ]; then
	...
	matlab -nodisplay -nodesktop -r "cd ../../; addpath(genpath(pwd)); obj = CryptStroma($a, $b, $c, $d, $e, $f, $g, $h, $j, 1); obj.RunToTime(300); v = Visualiser(obj); v.ProduceMovie([],[-1,11,-4,2],'Motion JPEG AVI'); quit()"
else 
